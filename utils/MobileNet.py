#the purpose of this file is to create the MobileNet architecture
...
def MobileNet(input_shape, 
    ...
    convolution(model, alpha, 32, (3,3), 2, reg_c, add_batch_norm, input_shape)
    separable_convolution(model, (3,3), (1,1), 1, 1, alpha, 64, reg_dc, reg_c, add_batch_norm)
    separable_convolution(model, (3,3), (1,1), 2, 1, alpha, 128, reg_dc, reg_c, add_batch_norm)
    separable_convolution(model, (3,3), (1,1), 1, 1, alpha, 128, reg_dc, reg_c, add_batch_norm)
    separable_convolution(model, (3,3), (1,1), 2, 1, alpha, 256, reg_dc, reg_c, add_batch_norm)
    separable_convolution(model, (3,3), (1,1), 1, 1, alpha, 256, reg_dc, reg_c, add_batch_norm)
    separable_convolution(model, (3,3), (1,1), 2, 1, alpha, 512, reg_dc, reg_c, add_batch_norm)
    for i in range(5):
